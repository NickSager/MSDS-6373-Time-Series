...
st_model_metrics <- data.frame(
  ...
  ASE = c(arma_stASE, arima_stASE, var_st_ase, mlr_st_ASE, ASE.mlp.st, ensemble_st_ASE),
...
lt_model_metrics <- data.frame(
  Model = c("ARMA", "ARIMA", "VAR", "MLR", "MLP", "Ensemble"),
  ASE = c(arma_ltASE, arima_ltASE, var_lt_ase, mlr_lt_ASE, ASE.mlp.lt, ensemble_lt_ASE),
