...
st_model_metrics <- data.frame(
  ...
  ASE = c(seasonal_stASE, arima_stASE, var_st_ase, mlr_st_ASE, ASE.mlp.st, NA),
  rwRMSE = c(seasonal_strwRMSE, arima_strwRMSE, NA, NA, NA, NA)
)
...
lt_model_metrics <- data.frame(
  Model = c("ARMA", "ARIMA", "VAR", "MLR", "MLP", "Ensemble"),
  ASE = c(seasonal_ltASE, arima_ltASE, var_lt_ase, mlr_lt_ASE, ASE.mlp.lt, NA),
  rwRMSE = c(seasonal_ltrwRMSE, arima_ltrwRMSE, NA, NA, NA, NA)
)
