...
# Year Out Forecast
mlr_lt_pred3 = predict(mlr, newxreg = data.frame(daily_bike_data$Humidity_lag[367:731], daily_bike_data$Temperature[367:731], daily_bike_data$Temperature_Feels[367:731], daily_bike_data$Day_of_the_Week[367:731], daily_bike_data$Wind_Speed[367:731]), n.ahead = 365, lastn= FALSE)
plot(seq(1,731,1),daily_bike_data$Total_Users,type = 'l',xlim = c(1,1100), main = "Long Term MLR Forecast")
points(seq(732,1096,1),mlr_lt_pred2$pred,type = 'l', pch = 1,col = 'blue',lwd=2, lty = 2)
```
